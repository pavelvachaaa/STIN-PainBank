...
export default function AccountCard({ account_id, currency, balance }: IAccount) {
    ...
    return (
        <div className="p-4 h-fit max-w-screen-md bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
            <div className="flex items-center justify-between">
                ...
                <div className="relative flex justify-around">
                    <div className="flex">
                        ...
                        <span className="leading-0 text-4xl font-bold text-gray-800 dark:text-white whitespace-normal">{balance.toFixed(2)}</span>
                    </div>
                </div>
            </div>
